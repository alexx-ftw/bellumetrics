...
export default function MethodologyPage() {
  return <main className="page-shell methodology">
    <header className="page-heading"><p className="eyebrow">Modelo abierto y revisable</p><h1>Metodología</h1><p>Commander Elo es un instrumento comparativo, no una sentencia sobre quién fue el mejor comandante de la historia.</p></header>
